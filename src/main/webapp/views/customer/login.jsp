...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('${pageContext.request.contextPath}/login/images/bg-02.jpg');">
...
<%--						<span class="focus-input100" data-placeholder="&#xe80f;"></span>--%>
					...
					<div class="container-login100-form-btn m-t-32">
						...
						<button class="login100-form validate-form">
							Login
						</button>
					</div>
				</form>
